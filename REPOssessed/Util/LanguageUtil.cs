...
namespace REPOssessed.Language
{
    ...
    public class LanguageUtil
    {
        ...
        {
            Assembly.GetExecutingAssembly().GetManifestResourceNames().Where(x => x.StartsWith("REPOssessed.Resources.Languages.") && x.EndsWith(".json")).ToList().ForEach(x =>
            {
                string jsonStr = null;
                try
                {
    ...
    public static class LanguageExtensions
    {
        ...
        {
            return LanguageUtil.Localize(key);
        }
        ...
        public static string[] LocalizeArray(this string[] keys)
        {
            return LanguageUtil.LocalizeArray(keys);
        }
    }
}